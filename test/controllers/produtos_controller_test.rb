...
class ProdutosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post produtos_url, params: { produto: { descricao: @produto.descricao, nome: @produto.nome, numero: @produto.numero, preco_compra: @produto.preco_compra, preco_venda: @produto.preco_venda, tipo: @produto.tipo } }
    end
  ...
  test "should update produto" do
    patch produto_url(@produto), params: { produto: { descricao: @produto.descricao, nome: @produto.nome, numero: @produto.numero, preco_compra: @produto.preco_compra, preco_venda: @produto.preco_venda, tipo: @produto.tipo } }
